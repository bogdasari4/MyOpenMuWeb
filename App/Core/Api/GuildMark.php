...
final class GuildMark
{
    ...
    public function __construct() {
        ...
        // Binary Data
        $binaryData = substr($this->formattedGet('data', '\x0044450004445550441551554515515655555566551551660551166000566600'), 2);
